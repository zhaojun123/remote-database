...
public class ParamWrapper {
    ...
    public ParamWrapper(ConnectionImpl connection, String sql,StatementType statementType){
        this.transcationId = connection.getTranscationId();
        this.sql = sql;
    ...
    public ParamWrapper(ConnectionImpl connection){
        this.transcationId = connection.getTranscationId();
        try {
            this.autoCommit = connection.getAutoCommit();
            this.transactionIsolation = connection.getTransactionIsolation();
